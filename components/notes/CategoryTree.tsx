  ...
  return (
    <div className={cn("flex items-center gap-1", className)}>
      <input
        ...
        className="min-w-0 flex-1 rounded border border-line-2 bg-base px-2 py-1.5 text-base text-ink outline-none placeholder:text-ink-3/55 focus:border-amber sm:py-1 sm:text-sm"
      />
      <button
        type="button"
